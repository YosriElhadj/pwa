...
import WorldDishesExplorer from '@/components/WorldDishesExplorer';
import Link from 'next/link';
import { useSession } from 'next-auth/react';

type ViewMode = 'community' | 'world';
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto text-center mb-8 animate-fadeIn">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-3">
            Explorez l'univers culinaire 🌍
          </h2>
          <p className="text-gray-600 text-sm sm:text-base mb-8">
            Découvrez des recettes de notre communauté ou explorez des plats du monde entier
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <button
              ...
              className={`group flex items-center gap-3 px-6 py-4 rounded-2xl font-bold transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 ${
                viewMode === 'community'
            ...
            >
              ...
              <div className="text-left">
                <div className="text-sm sm:text-base">Communauté</div>
                <div className={`text-xs font-medium ${viewMode === 'community' ? 'text-white/80' : 'text-gray-500'}`}>
                  Recettes partagées
                </div>
              </div>
            </button>
            ...
            >
              <span className="text-2xl sm:text-3xl">🌍</span>
              <div className="text-left">
                <div className="text-sm sm:text-base">Plats du Monde</div>
                <div className={`text-xs font-medium ${viewMode === 'world' ? 'text-white/80' : 'text-gray-500'}`}>
                  Base USDA
                </div>
              </div>
            </button>
          ...
          {/* Community Search Bar (only show in community mode) */}
          {viewMode === 'community' && (
        ...
        {viewMode === 'community' && (
          <>
            {/* Tri */}
            <div className="flex justify-center gap-2 mb-6 animate-fadeIn flex-wrap">
              <button
